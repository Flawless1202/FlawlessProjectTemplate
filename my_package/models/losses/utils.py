...
def reduce_loss(loss: Tensor, reduction: str) -> Tensor:
    ...
    Args:
        loss: Elementwise losses tensor.
        reduction: Options are "none", "mean" and "sum".
...
def weight_reduce_loss(
    ...
    Args:
        loss: Element-wise losses.
        weight: Element-wise weights.
        reduction: Same as built-in losses of PyTorch.
        avg_factor: Avarage factor when computing the mean of losses.
